...
def evaluate_sess(sess, model_spec, num_steps, writer=None, params=None):
    ...
    Args:
        ...
        writer: (tf.summary.FileWriter) writer for summaries.
                Is None if we don't log anything
...
def evaluate(model_spec, model_dir, params, restore_from):
    ...
    Args:
        ...
        params: (Params) contains hyperparameters of the model.
                Must define: num_epochs, train_size, batch_size, eval_size,
                save_summary_steps
        restore_from: (string) directory or file containing
                      weights to restore the graph
    """
